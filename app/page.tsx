    ...
    <div className="min-h-screen bg-[#02012B] sm:px-20 sm:py-10 px-5 py-5 transition duration-200 ease-in-out">
      ...
      {deuErroNaApi ? (
        <div className="flex justify-center flex-col items-center gap-4">
          <h1 className="text-white text-3xl font-bricolage font-semibold">Something went wrong</h1>
          <span className="text-[#D1D0DE]">We couldn't connect to the server (API error). Please try again in a few moments.</span>
          <button
