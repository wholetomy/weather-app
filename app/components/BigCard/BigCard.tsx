...
export default function BigCard({
    ...
    if (isSearchBeingDone) {
        return (
            <div className="bg-[#262640] h-56 w-full rounded-lg md:col-span-4 order-1 md:order-0 relative z-10 gap-2 flex flex-col justify-center items-center text-white">
